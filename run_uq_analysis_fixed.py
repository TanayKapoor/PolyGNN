...
class SimpleUQ:
    ...
    def ensemble_predict(self, models: List[nn.Module], test_dataset) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    ...
    def analyze_uncertainty(self, predictions: np.ndarray, uncertainties: np.ndarray, targets: np.ndarray) -> Dict:
    ...
    def run_simple_uq(self, n_models: int = 3) -> Dict:
        ...
        # Get predictions
        predictions, uncertainties, targets = self.ensemble_predict(models, test_dataset)
